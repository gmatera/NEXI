...
@NoArgsConstructor
@Entity
@Table(name = "FTS_SEND_MQI")
public class FTSSendMQ implements CswEntityOutMqWithFile {

	public static final String ID = "ID_SEND_FILE";
	public static final String TABLE_NAME = "FTS_SEND_MQI";
	...
	@NotNull
	@GeneratedValue(generator="SEQ_FTS_SEND_MQI", strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name="SEQ_FTS_SEND_MQI", sequenceName="SEQ_FTS_SEND_MQI", allocationSize=1)
	private Long id;
