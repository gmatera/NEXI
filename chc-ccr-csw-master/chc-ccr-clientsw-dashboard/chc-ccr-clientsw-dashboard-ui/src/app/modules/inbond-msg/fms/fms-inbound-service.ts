...
import { FMSRecvDTO, FMSRecvFilterDTO } from "./dto/fms-inbound-dto";
...
export class FMSInboundService extends CommonInOutMessagesService<FMSRecvDTO, FMSRecvFilterDTO>{

    constructor(private httpService: CommonService, notify: NotificationService, confirmationDialog: MatDialog){
        super(httpService, ControllerPath.FMSDB_PREFIX + ConfigPathInOut.INBOUND,  confirmationDialog, notify);
    }
}