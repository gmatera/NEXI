...
import { ADDONOutDTO, ADDONOutFilterDTO } from "./dto/addon-inbound-dto";
...
export class ADDONInboundService extends CommonInOutMessagesService<ADDONOutDTO, ADDONOutFilterDTO>{

    constructor(private httpService: CommonService, notify: NotificationService, confirmationDialog: MatDialog){
        super(httpService, ControllerPath.FTSDBFS_PREFIX + ConfigPathInOut.INBOUND,  confirmationDialog, notify);
    }
}