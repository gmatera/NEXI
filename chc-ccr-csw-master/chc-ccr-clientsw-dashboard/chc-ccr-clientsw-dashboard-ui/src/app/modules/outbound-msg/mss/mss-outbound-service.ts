...
import { MSSSendDTO, MSSSendFilterDTO } from "./dto/mss-outbound-dto";
...
export class MSSOutboundService extends CommonInOutMessagesService<MSSSendDTO, MSSSendFilterDTO>{

    constructor(private httpService: CommonService, notify: NotificationService, confirmationDialog: MatDialog){
        super(httpService, ControllerPath.MSSDB_PREFIX + ConfigPathInOut.OUTBOUND, confirmationDialog, notify);
    }
}